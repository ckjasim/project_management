...
Router.get('/chat/teamListByEmployee', controller.teamListByEmployeeHandler.bind(controller));
Router.get('/chat/getChats', controller.getChatsHandler.bind(controller));
