...
export default interface IUserController {
    ...
    recoverPasswordHandler(req: Request, res: Response,next:NextFunction): Promise<void>;
    submitPasswordHandler(req: Request, res: Response,next:NextFunction): Promise<void>;
    recoverOtpHandler(req: Request, res: Response,next:NextFunction): Promise<void>;
