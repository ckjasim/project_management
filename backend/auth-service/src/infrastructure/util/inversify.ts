...
container
  .bind<IUserRepository>(INTERFACE_TYPES.UserRepository)
  .to(UserRepository);
container
  .bind<IOrganizationRepository>(INTERFACE_TYPES.OrganizatonRepository)
  .to(organizationRepository);
container
  .bind<IInvitationRepository>(INTERFACE_TYPES.invitationRepository)
  .to(InvitationRepository);
container
  .bind<IEmployeeRepository>(INTERFACE_TYPES.EmployeeRepository)
  .to(EmployeeRepository);
container
  .bind<IRefreshTokenRepository>(INTERFACE_TYPES.RefreshTokenRepository)
  .to(refreshTokenRepository);

container
  .bind<IUserInteractor>(INTERFACE_TYPES.UserInteractor)
  .to(UserInteractors);
container
  .bind<IAdminInteractor>(INTERFACE_TYPES.AdminInteractor)
  .to(AdminInteractor);
container
  .bind<IEmployeeInteractor>(INTERFACE_TYPES.EmployeeInteractor)
  .to(EmployeeInteractor);

container
  .bind<IUserController>(INTERFACE_TYPES.UserController)
  .to(userAuthController);
container
  .bind<IGoogleAuthService>(INTERFACE_TYPES.GoogleAuthService)
  .to(GoogleAuthService);
container
  .bind<IEmployeeController>(INTERFACE_TYPES.EmployeeController)
  .to(EmployeeAuthController);
container
  .bind<IAdminController>(INTERFACE_TYPES.AdminController)
...
container
  .bind<IEmailService>(INTERFACE_TYPES.NodeMailerService)
